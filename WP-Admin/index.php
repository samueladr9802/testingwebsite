...
<head>
    ...
    <link href="../plugin/datepicker/vendor/datepicker/daterangepicker.css" rel="stylesheet" media="all">
...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                if (isset($_GET['page'])) {
                    ...
                    } elseif ($page == "data-wilayah") {
                        include_once 'content/datawilayah.php';
                    } elseif ($page == "data-keluarga") {
                        include_once 'content/datakeluarga.php';
                    }
                } else {
                    include_once 'content/dashboard.php';
                }
    ...
    <script src="../plugin/datepicker/vendor/datepicker/moment.min.js"></script>
    <script src="../plugin/datepicker/vendor/datepicker/daterangepicker.js"></script>

    <!-- Page level custom scripts -->
    <script src="js/demo/datatables-demo.js"></script>
    <!-- Main JS-->
    <script src="../plugin/datepicker/js/global.js"></script>
