<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Nav Item - Profile -->
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#kuisioner" aria-expanded="true" aria-controls="kuisioner">
            <i class="fas fa-tasks"></i>
            <span>Kuisioner</span>
        </a>
        <div id="kuisioner" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="?page=kelola-pertanyaan">Pertanyaan</a>
            </div>
        </div>
    </li>
    ...
    <!-- Nav Item - Profile -->
    <li class="nav-item">
        <a class="nav-link" href="?page=hasil-survei">
